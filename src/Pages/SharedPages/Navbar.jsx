          ...
          <div className="navbar-center">
            <div className="dropdown">
              ...
              >
                ...
                <ul>
                  <li>
                    <p className="text-base text-slate-200 px-3 py-1">
                      {user?.role}
                    </p>
                  </li>
                  <li>
                    <p className="overflow-x-auto text-base text-slate-200 px-3 py-1">
                      {user?.email}
                    </p>
                  </li>
                  {/* <li>
            ...
            {user ? (
              <div className="dropdown dropdown-end">
                ...
                <ul className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                  <li>
                    <p className="text-base text-slate-200 px-3">
                      {user?.name}
                    </p>
                  </li>
                  <li>
                    <p className="w-[200px] overflow-x-auto text-base text-slate-200 px-3">
                      {user?.email}
                    </p>
                  </li>
                  <li>
